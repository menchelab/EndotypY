...
def main():
    ...
    # 7. Save to nodes_out.parquet
    print("\n7. Saving to nodes_out.parquet...")
    output_df.to_parquet('nodes_out.parquet', index=False, engine='pyarrow')
    print(f"   ✓ Saved {len(output_df):,} nodes to nodes_out.parquet")
    ...
    print("=" * 60)
    print("\nOutput file:")
    print("  - nodes_out.parquet: Full dataset with coordinates, degrees, and Endotype")
