...
def _visualization_endotype_with_hulls(final_pos, 
    ...
    plt.tight_layout()
    # optionally save high-resolution png or svg image
    #fig.savefig("endotypes_highres.png", dpi=300, bbox_inches="tight")
    #fig.savefig("endotypes_highres.svg", bbox_inches="tight") 
